...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thehashcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thehashcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thehashcoin transaction") + "\n" +
              "  thehashcoin-tx [options] -create [commands]   " + _("Create hex-encoded thehashcoin transaction") + "\n" +
              "\n";

Thehashcoin Core version *0.15.1* is now available from:

  <https://download.thehashcoin.org/thehashcoin-0.15.1/>
...
A number of changes to the way Thehashcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 micro-THC per kB (0.00001 THC). This is to prepare for dropping the minimum transaction fee to 0.1 micro-THC per kB (0.0001 THC) in the next release.

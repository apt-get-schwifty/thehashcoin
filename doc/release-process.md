...
Ensure your gitian.sigs.thc are up-to-date if you wish to gverify your builds against other Gitian signatures.

    pushd ./gitian.sigs.thc
    git pull
    popd
...
### Build and sign Thehashcoin Core for Linux, Windows, and OS X:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.thc/ ../thehashcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.thc/ ../thehashcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.thc/ ../thehashcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  5. Gitian signatures (in `gitian.sigs.thc/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)
...
Commit your signature to gitian.sigs.thc:
    ...
    git commit -a
    git push  # Assuming you can push to the gitian.sigs.thc tree
    popd
...
Create (and optionally verify) the signed OS X binary:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.thc/ ../thehashcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.thc/ ../thehashcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.thc/ -r ${VERSION}-win-signed ../thehashcoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the thehashcoin.org server.
